<?php 
	...
	function buscar($nro,$conn){
		$sql="select * from noticias where seccion=$nro";
		$res=mysqli_query($conn,$sql) or die ('No se puede insertar la noticia: '. mysqli_error($conn));
			...
			<div class="main">
				...
				<nav>
					<ul class="menu">
                        ...
                        <li><a href="usuarios/pidodatos.php">Login</a></li>
					</ul>
				</nav>
				<div class="clear"></div>
			</div>
